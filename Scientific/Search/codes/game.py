...
class MyGame(arcade.Window):
    ...
    def start_new_game(self):
        ...
        for i in range(50):
            ...
            coin = Coin("images/coin.png", SPRITE_SCALING / 5)
    ...
    def update(self, delta_time):
        ...
        self.player_sprite.center_x, self.player_sprite.center_y = \
            self.agent_logic(self.player_sprite.center_x, self.player_sprite.center_y)


def main(agent_logic):
    window = MyGame(SCREEN_WIDTH, SCREEN_HEIGHT)
    window.agent_logic = agent_logic
